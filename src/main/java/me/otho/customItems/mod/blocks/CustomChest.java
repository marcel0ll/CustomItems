...
public class CustomChest extends Block implements ITileEntityProvider {
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_,
        ...
        TileEntityCustomChest tile = (TileEntityCustomChest) p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_,
                p_149689_4_);
    ...
    public void breakBlock(World world, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_,
            int p_149749_6_) {
        TileEntityCustomChest tileentitychest = (TileEntityCustomChest) world.getTileEntity(p_149749_2_, p_149749_3_,
                p_149749_4_);
            ...
            for (int i1 = 0; i1 < tileentitychest.getSizeInventory(); ++i1) {
                ...
                if (itemstack != null) {
                    ...
                    for (float f2 = world.rand.nextFloat() * 0.8F + 0.1F; itemstack.stackSize > 0; world
                        ...
                        entityitem = new EntityItem(world, (double) ((float) p_149749_2_ + f),
