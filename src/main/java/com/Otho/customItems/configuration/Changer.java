...
public class Changer {
	...
	public static void changeSingleBlock(Cfg_change_block blockData)
	{
		...
		{
			blockData.toolClass = RegisterCustomItems.validateToolClass(blockData.toolClass);
		...
		if(parsing[0] != null && parsing[1] != null)
		{
			...
			block.setStepSound(RegisterCustomItems.parseSoundType(blockData.stepSound));
